...
def requestPost(url: str, payload: Dict[str, Any], headers: Optional[Dict[str, Any]] = None) -> requests.Response:
    return _request("POST", url, headers=headers, json=payload)

def requestGet(url: str, headers: Dict[str, Any], params: Optional[Dict[str, Any]] = None) -> requests.Response:
    return _request("GET", url, headers=headers, params=params)

def requestPatch(url: str, headers: Dict[str, Any], body: Dict[str, Any]) -> requests.Response:
    return _request("PATCH", url, headers=headers, json=body)

def requestPut(url: str, headers: Dict[str, Any], data: Optional[Dict[str, Any]] = None) -> requests.Response:
